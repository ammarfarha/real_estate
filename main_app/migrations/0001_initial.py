    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('CO', 'Commercial'), ('RE', 'Residential'), ('IN', 'Industrial'),
                                                   ('SP', 'Special Purpose'), ('LA', 'Lands')], default='CO',
                                          max_length=2, null=True, verbose_name='Type of the Project')),
                ('statue', models.CharField(
                    choices=[('PL', 'Planing'), ('IN', 'Initial'), ('UC', 'Under Construction'), ('DO', 'Done'),
                             ('RE', 'Ready To Use')], default='PL', max_length=2, null=True,
                    verbose_name='The project Status')),
                ('location', djgeojson.fields.PointField()),
                ('area',
                 models.DecimalField(decimal_places=2, max_digits=10, null=True, verbose_name='Area in Square Meters')),
                ...
                ('developer',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='projects',
                                   to='accounts.developer', verbose_name='Developer')),
            ],
        ),
        migrations.CreateModel(
            name='SubPhase',
            fields=[
                ...
                ('phase',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_phases',
                                   to='main_app.mainphase', verbose_name='Sub Phase')),
            ],
        ),
        migrations.CreateModel(
            name='SubPhaseUpdate',
            fields=[
                ...
                ('sub_phase',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='updates',
                                   to='main_app.subphase', verbose_name='Sub Phase Update')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attachments',
                                   to='main_app.subphaseupdate', verbose_name='Update Sun Phase')),
            ],
        ),
        migrations.CreateModel(
            name='Subscription',
            fields=[
                ...
                ('project',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions',
                                   to='main_app.project', verbose_name='Project')),
                ('referral_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE,
                                              related_name='project_images', to='main_app.project',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='main_phases',
                                    to='main_app.project', verbose_name='Project'),
        ),
    ]
