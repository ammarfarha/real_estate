    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('CO', 'Commercial'), ('RE', 'Residential'), ('IN', 'Industrial'), ('SP', 'Special Purpose'), ('LA', 'Lands')], default='CO', max_length=2, null=True, verbose_name='Type')),
                ('statue', models.CharField(choices=[('PL', 'Planning'), ('IN', 'Initial'), ('UC', 'Under Construction'), ('DO', 'Done'), ('RE', 'Ready To Use')], default='PL', max_length=2, null=True, verbose_name='Status')),
                ('visibility', models.CharField(choices=[('UR', 'Under Review'), ('P', 'Published'), ('HD', 'Hidden by the Developer'), ('HA', 'Hidden by he Admin')], default='UR', max_length=2, null=True, verbose_name='Visibility')),
                ('location', djgeojson.fields.PointField()),
                ('area', models.DecimalField(decimal_places=0, max_digits=10, null=True, verbose_name='Area (Square Meters)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completion_date', models.DateTimeField(blank=True, null=True, verbose_name='Actual Completion Date')),
                ('phase', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_phases', to='main_app.mainphase', verbose_name='Main Phase')),
            ],
        ),
        migrations.CreateModel(
            name='SubPhaseUpdate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions_by', to=settings.AUTH_USER_MODEL, verbose_name='Referral User')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectImage',
