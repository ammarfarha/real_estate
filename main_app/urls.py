...
urlpatterns = [
    ...
    path('admin_my_projects/', views.AdminDeveloperProjectsListView.as_view(), name='admin-my-project-list'),
    ...
    path('subscribe/<int:pk>/', views.ClientSubscribeProjectView.as_view(), name='upload-image'),
]
