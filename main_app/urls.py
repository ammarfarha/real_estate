...
urlpatterns = [
    ...
    path('project/<int:pk>/main/phase/<int:main_phase_pk>/', views.ProjectMainPhaseUpdateView.as_view(),
         name='update-main-phase'),
    path('project/<int:pk>/sub/phase/', views.ProjectSubPhaseCreateView.as_view(), name='create-sub-phase'),
    path('project/<int:pk>/sub/phase/<int:sub_phase_pk>/', views.ProjectSubPhaseUpdateView.as_view(),
         name='update-sub-phase'),
    ...
    path('project/phases/subphases/updates/<int:sub_phase_pk>/', views.ProjectPhasesListView.as_view(),
         name='sub-phase'),
    path('project/phases/subphases/updates/<int:sub_phase_pk>/add/', views.AddSubPhaseUpdateView.as_view(),
         name='add-update'),
