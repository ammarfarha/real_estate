...
urlpatterns = [
    ...
    # path('my_projects/<int:ppk>/<int:mpk>/delete/', views.ProjectDeleteView.as_view(), name='main-phase-delete'),
    path('my_projects/<int:ppk>/<int:mpk>/details/', views.SubPhasesView.as_view(), name='main-phase-details'),
]
