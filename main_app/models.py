...
class Project(models.Model):
    ...
    area = models.DecimalField(verbose_name=_('Area in Square Meters'),
                               max_digits=10,
                               decimal_places=2,
                               null=True,
                               blank=False,
                               )
    stakeholders = models.TextField(verbose_name=_('Project Stakeholders'),
                                    null=True,
                                    blank=True
                                    )
    neighborhood = models.TextField(verbose_name=_('Project Neighborhood'),
                                    null=True,
                                    blank=True
                                    )
...
class Subscription(models.Model):
    ...
    referral_user = models.ForeignKey(User,
                                      related_name='subscriptions',
...
class SubPhase(models.Model):
    # Constants:
    # Fields:
    phase = models.ForeignKey(MainPhase,
    ...
    end_date = models.DateField(verbose_name=_('Finish Date'),
                                null=True,
                                blank=False,
                                )
    completion_date = models.DateTimeField(verbose_name=_('Duration'),
                                           null=True,
                                           blank=False,
                                           )
...
class SubPhaseUpdate(models.Model):
    # Constants:
    # Fields:
    sub_phase = models.ForeignKey(SubPhase,
    ...
    description = models.TextField(verbose_name=_('Update Description'),
                                   null=True,
                                   blank=False,
                                   )
...
class UpdateAttachment(models.Model):
    # Constants:
    # Fields:
    update = models.ForeignKey(SubPhaseUpdate,
    ...
    update_file = models.FileField(verbose_name=_('Attachment'),
                                   null=True,
                                   blank=True,
                                   )
